...
public class GuiZytaniumFurnace extends GuiContainer
{
    private TileEntityZytaniumFurnace furnaceInventory;

    public GuiZytaniumFurnace(InventoryPlayer par1InventoryPlayer, TileEntityZytaniumFurnace par2TileEntityFurnace)
    {
        super(new ContainerZytaniumFurnace(par1InventoryPlayer, par2TileEntityFurnace));
