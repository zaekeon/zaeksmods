package com.zaekeon.zaeksmod.tileentity;
...
public class TileEntityZytaniumFurnace extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Zytnaium Furnace";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Zytanium Furnace"))
        {
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockZytaniumFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = ZytaniumFurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
